...
public class AlbumController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('ROLE_ARTISTA')")
    public ResponseEntity<NovoRecursoResponse> criarAlbum(@RequestBody @Valid final CriarAlbumRequest request) {
    ...
    public ResponseEntity<RecursoAtualizadoResponse> atualizarAlbum(
            ...
            @RequestBody @Valid final AtualizarAlbumRequest request) {
        final UUID usuarioId = getUsuarioId();
    ...
    public ResponseEntity<RecursoDeletadoResponse> removerAlbumSalvo(@PathVariable("id") final UUID id) {
        final UUID usuarioId = getUsuarioId();
