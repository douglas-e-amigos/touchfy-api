...
public class TagController {
  ...
  @PostMapping
  public ResponseEntity<NovoRecursoResponse> criarTag(
      @RequestBody @Valid final CriarTagRequest request) {
  ...
  public ResponseEntity<RecursoAtualizadoResponse> atualizarTag(
      @PathVariable("id") final UUID id, @RequestBody final AtualizarTagRequest request) {
  ...
  public ResponseEntity<RecursoDeletadoResponse> deletarTag(@PathVariable("id") final UUID id) {
    ...
    return ResponseEntity.ok(
        new RecursoDeletadoResponse("Tag deletada com sucesso!", Boolean.TRUE, LocalDate.now()));
  }
}
