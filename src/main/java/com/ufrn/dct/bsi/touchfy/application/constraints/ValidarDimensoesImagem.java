...
public class ValidarDimensoesImagem implements ConstraintValidator<DimensoesImagemValida, MultipartFile> {
    ...
    public boolean isValid(final MultipartFile multipartFile,
        ...
        try {
            ...
            if (largura < this.dimensoes.getLarguraMinima() || largura > this.dimensoes.getLarguraMaxima()) {
                return false;
            }
