...
public class GarageFileStorageImpl implements FileStorageService {
  ...
  public ArquivoArmazenamentoResponse store(final MultipartFile file, final String subDirectory) {
    ...
    return new ArquivoArmazenamentoResponse(nomeOriginal, chave, extensao, (double) file.getSize());
  }
  ...
  public void delete(final String caminhoDoArquivo) {
    try {
      final DeleteObjectRequest deleteObjectRequest =
          DeleteObjectRequest.builder().bucket(bucketName).key(caminhoDoArquivo).build();
  ...
  public ArquivoRecuperadoResponse retrieve(final String caminhoDoArquivo) {
    try {
      final GetObjectRequest request =
          GetObjectRequest.builder().bucket(bucketName).key(caminhoDoArquivo).build();
