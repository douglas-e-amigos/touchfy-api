...
class CriarUsuarioUseCaseTest {
  ...
  private CriarUsuarioRequest requestValido() {
    return new CriarUsuarioRequest(
        "Nome", "user", "senha", "senha", "teste@email.com", LocalDate.now(), ERole.OUVINTE);
  }
  ...
  void deveLancarErroQuandoSenhaForNula() {
    var request =
        new CriarUsuarioRequest(
            "Nome", "user", null, null, "teste@email.com", LocalDate.now(), ERole.OUVINTE);
  ...
  void deveLancarErroQuandoSenhasForemDiferentes() {
    var request =
        new CriarUsuarioRequest(
            "Nome", "user", "senha1", "senha2", "teste@email.com", LocalDate.now(), ERole.OUVINTE);
