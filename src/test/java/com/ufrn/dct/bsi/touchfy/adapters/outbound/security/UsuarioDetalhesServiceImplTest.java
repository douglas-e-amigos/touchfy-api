...
class UsuarioDetalhesServiceImplTest {
  ...
  void deveRetornarUserDetailsQuandoUsuarioExiste() {
    ...
    when(usuarioRepository.acharPeloNomeDeUsuario(username)).thenReturn(Optional.of(usuario));
  ...
  void deveLancarExcecaoQuandoUsuarioNaoExiste() {
    ...
    final RuntimeException exception =
        assertThrows(RuntimeException.class, () -> service.loadUserByUsername(username));
