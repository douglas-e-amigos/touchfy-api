...
class ValidarExtensaoTest {
  ...
  void setUp() {
    ...
    final ExtensaoValida annotation = mock(ExtensaoValida.class);

    when(annotation.value()).thenReturn(new String[] {"jpg", "jpeg", "png"});
  ...
  void deveRetornarVerdadeiroParaExtensaoJpg() {
    final MultipartFile arquivo =
        new MockMultipartFile("foto", "foto.jpg", "image/jpeg", "conteudo".getBytes());
  ...
  void deveRetornarVerdadeiroParaExtensaoJpeg() {
    final MultipartFile arquivo =
        new MockMultipartFile("foto", "foto.jpeg", "image/jpeg", "conteudo".getBytes());
  ...
  void deveRetornarVerdadeiroParaExtensaoPng() {
    final MultipartFile arquivo =
        new MockMultipartFile("foto", "foto.png", "image/png", "conteudo".getBytes());
  ...
  void deveRetornarFalsoParaExtensaoInvalida() {
    final MultipartFile arquivo =
        new MockMultipartFile("foto", "foto.gif", "image/gif", "conteudo".getBytes());
  ...
  void deveRetornarFalsoParaArquivoSemExtensao() {
    final MultipartFile arquivo =
        new MockMultipartFile("foto", "foto", "image/jpeg", "conteudo".getBytes());
  ...
  void naoDeveAceitarExtensaoNaoConfigurada() {
    final MultipartFile arquivo =
        new MockMultipartFile("foto", "foto.bmp", "image/bmp", "conteudo".getBytes());
