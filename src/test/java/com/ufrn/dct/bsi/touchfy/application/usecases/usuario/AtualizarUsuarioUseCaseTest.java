...
class AtualizarUsuarioUseCaseTest {
  ...
  private AtualizarUsuarioRequest criarRequest() {
    return new AtualizarUsuarioRequest("Novo Nome", "novo_username", LocalDate.of(2000, 1, 1));
  }
  ...
  void deveChamarRepositoryComParametrosCorretos() {
    ...
    verify(usuarioRepository, times(1)).atualizarUsuarioParcialmente(id, request);
  }
