...
class UploadArquivoUseCaseTest {
  ...
  void deveChamarStoreComParametrosCorretos() {
    ...
    final ArquivoArmazenamentoResponse responseEsperado =
        new ArquivoArmazenamentoResponse("foto.png", "perfil/uuid.png", "png", 8.0);
  ...
  void deveRetornarResponseDoStorage() {
    final MockMultipartFile file =
        new MockMultipartFile("file", "musica.mp3", "audio/mpeg", "conteudo".getBytes());

    final ArquivoArmazenamentoResponse responseEsperado =
        new ArquivoArmazenamentoResponse("musica.mp3", "musicas/uuid.mp3", "mp3", 8.0);
