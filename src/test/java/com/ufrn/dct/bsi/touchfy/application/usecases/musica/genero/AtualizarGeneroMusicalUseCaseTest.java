...
class AtualizarGeneroMusicalUseCaseTest {
    ...
    void deveAtualizarGeneroMusicalQuandoRequestForValido() {
        ...
        final AtualizarGeneroMusicalRequest request = new AtualizarGeneroMusicalRequest("Rock progressivo");
    ...
    void deveLancarExcecaoQuandoIdForNulo() {
        ...
        final var exception = assertThrows(IllegalArgumentException.class, () -> useCase.execute(null, request));
