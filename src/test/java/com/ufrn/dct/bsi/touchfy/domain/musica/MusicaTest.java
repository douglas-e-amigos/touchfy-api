...
class MusicaTest {
    ...
    void deveCriarMusicaQuandoDadosForemValidos() {
        ...
        final Musica musica = new Musica(id, "Tempo Perdido", "musicas/abc/arquivo.mp3", "Letra", null, null);
    ...
    void deveLancarExcecaoQuandoIdForNulo() {
        final IllegalArgumentException exception = assertThrows(
                ...
                () -> new Musica(null, "Tempo Perdido", "musicas/abc/arquivo.mp3", null, List.of(), List.of())
        );
    ...
    void deveLancarExcecaoQuandoNomeForNulo() {
        final IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> new Musica(UUID.randomUUID(), null, "musicas/abc/arquivo.mp3", null, List.of(), List.of())
        );
