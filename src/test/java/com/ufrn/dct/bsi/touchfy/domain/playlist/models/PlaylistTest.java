...
class PlaylistTest {
    ...
    void deveCriarPlaylistQuandoDadosForemValidos() {
        ...
        final var playlist = new Playlist(id, "Minha Playlist", "Descrição",
                Visibilidade.PUBLICA, donoId, List.of(), List.of());
    ...
    void deveLancarExcecaoQuandoIdForNulo() {
        assertThrows(IllegalArgumentException.class, () ->
                new Playlist(null, "Nome", null, Visibilidade.PUBLICA,
    ...
    void deveLancarExcecaoQuandoNomeForNulo() {
        assertThrows(IllegalArgumentException.class, () ->
                new Playlist(UUID.randomUUID(), null, null, Visibilidade.PUBLICA,
                        UUID.randomUUID(), List.of(), List.of()));
    }
    ...
    void deveLancarExcecaoQuandoNomeForVazio() {
        assertThrows(IllegalArgumentException.class, () ->
                new Playlist(UUID.randomUUID(), "", null, Visibilidade.PUBLICA,
                        UUID.randomUUID(), List.of(), List.of()));
    }
    ...
    void deveLancarExcecaoQuandoVisibilidadeForNula() {
        assertThrows(IllegalArgumentException.class, () ->
                new Playlist(UUID.randomUUID(), "Nome", null, null,
                        UUID.randomUUID(), List.of(), List.of()));
    }
    ...
    void deveLancarExcecaoQuandoDonoForNulo() {
        assertThrows(IllegalArgumentException.class, () ->
                new Playlist(UUID.randomUUID(), "Nome", null, Visibilidade.PUBLICA,
                        null, List.of(), List.of()));
    }

    @Test
    void deveInicializarListasVaziasQuandoMusicasForNulo() {
        final var playlist = new Playlist(UUID.randomUUID(), "Nome", null,
                Visibilidade.PUBLICA, UUID.randomUUID(), null, null);
