...
class BuscarPlaylistUseCaseTest {
    ...
    void deveRetornarPlaylistQuandoUsuarioForDonoDePlaylistPrivada() {
        ...
        final var playlist = new Playlist(playlistId, "Nome", null, Visibilidade.PRIVADA,
                donoId, List.of(), List.of());
        final var response = new PlaylistResponse(playlistId, "Nome", null,
                Visibilidade.PRIVADA, donoId, List.of(), null, null);
    ...
    void deveLancarExcecaoQuandoPlaylistPrivadaForAcessadaPorOutroUsuario() {
        ...
        assertThrows(RuntimeException.class,
                () -> useCase.execute(playlistId, UUID.randomUUID()));
    }
    ...
    void devePermitirVisualizarPlaylistProtegidaQuandoUsuarioForConvidado() {
        ...
        final var playlist = new Playlist(playlistId, "Nome", null, Visibilidade.PROTEGIDA,
                UUID.randomUUID(), List.of(), List.of(convidadoId));
