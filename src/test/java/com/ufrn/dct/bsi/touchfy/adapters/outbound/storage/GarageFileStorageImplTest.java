...
class GarageFileStorageImplTest {
  ...
  void deveSalvarArquivoERetornarResponse() {
    final MockMultipartFile file =
        new MockMultipartFile("file", "foto.png", "image/png", "conteudo".getBytes());
  ...
  void deveLancarExcecaoQuandoArquivoSemExtensao() {
    final MockMultipartFile file =
        new MockMultipartFile("file", "arquivo-sem-extensao", "image/png", "conteudo".getBytes());

    assertThrows(IllegalArgumentException.class, () -> storage.store(file, "perfil"));
  }
  ...
  void deveLancarExcecaoQuandoFalhaNoUpload() {
    ...
    assertThrows(IntegracaoExternaException.class, () -> storage.store(file, "perfil"));
  }
  ...
  void deveLancarExcecaoQuandoFalhaNaBusca() {
    ...
    assertThrows(IntegracaoExternaException.class, () -> storage.retrieve("perfil/uuid.png"));
  }
}
